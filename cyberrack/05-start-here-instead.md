...
# Can I start here instead of the laptop?

You have hardware, or the budget for it, and the laptop path looks like a
detour. Reasonable question, and the answer has two halves.

**Yes, the course runs on this.** No, I don't think a beginner should
start that way.

## Why the course still says laptop

Not because the laptop is better. Because of what you'd be debugging.
...
On a laptop, when something breaks, it's you. That sounds worse and is
...
**Run Module 3 on the laptop, then move.**
...
Module 4 is the interesting one, and I'd do it twice. Once as written, on
the laptop, so you understand what a network segment *is* without cables
...
something doesn't work, and keep a laptop VM available for the moments
