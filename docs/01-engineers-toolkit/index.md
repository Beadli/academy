---
title: "Module 1: The engineer's toolkit"
sidebar_position: 0
---
...
every hour spent here pays back for fourteen modules.
...
it's whether they keep notes. Six months into your lab you will hit an
error you've already solved once. The person with a journal searches it,
finds their own fix, and moves on in two minutes. The person without one
solves it again from scratch and learns nothing new doing it. I've been
...
Tier required: none. Any machine that passed checkpoint 0.6 is more than
enough, and most of this works even on the 8 GB laptops I warned about.
Budget a weekend if these tools are new to you.
